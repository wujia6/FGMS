...
namespace FGMS.Core.Migrations
{
    ...
    [Migration("20260517010825_update60")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FGMS.Models.Entities.MaterialDiameter", b =>
                {
                    ...
                    b.Property<double?>("FyStandardMinutes")
                        .HasPrecision(6, 2)
                        .HasColumnType("float(6)");
            ...
            modelBuilder.Entity("FGMS.Models.Entities.ProductionOrderLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FGMS.Models.Entities.WorkOrder", b =>
                {
                    ...
                    b.Property<string>("RepairEquipmentCode")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("FGMS.Models.Entities.MenuInfo", b =>
                {
                    b.HasOne("FGMS.Models.Entities.MenuInfo", "Parent")
                        .WithMany("Childrens")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FGMS.Models.Entities.ProductionOrderLog", b =>
                {
                    b.HasOne("FGMS.Models.Entities.UserInfo", "Operator")
                        .WithMany()
